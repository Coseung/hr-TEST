...
export const ScheduleView: React.FC<ScheduleViewProps> = ({ user, currentDate, onDateChange }) => {
  ...
  const openAddModal = (dateStr?: string, templateId?: string) => {
      // If user is NOT admin and templateId is company, default to personal
  ...
  const handleAddEvent = () => {
    ...
    if (newEvent.templateId === 'company' && !isAdmin) return alert('권한이 없습니다.');
                ...
                {isTemplateMenuOpen && (
                    <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-1 z-30">
                        ...
                        <div className="max-h-60 overflow-y-auto">
                            {templates.map(t => {
                                // Hide Company Schedule for Non-Admins in Dropdown
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                      ...
                      <div className="flex-1 flex flex-wrap gap-2">
                        {templates.map(t => {
                            // Hide Company Schedule in Selection if Not Admin
                            if (t.id === 'company' && !isAdmin) return null;
                            return (
                                <button 
                                    key={t.id}
